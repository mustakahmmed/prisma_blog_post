              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                  <td align="center" valign="top" style="padding: 36px 24px;">
                    <a href="${process.env.APP_URL}" target="_blank" style="display: inline-block;">
                      <h1 style="color: #333; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif;">Prisma Blog</h1>
                    </a>
                  </td>
                </tr>
              </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                  <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account with Prisma Blog, you can safely delete this email.</p>
                  </td>
                </tr>
                <tr>
